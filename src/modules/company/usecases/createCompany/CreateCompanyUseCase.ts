...
class CreateCompanyUseCase implements UseCase<CreateCompanyUseCaseRequest, CreateCompanyUseCaseResponse> {
  constructor(private repository: CompanyRepository, private idGenerator: IdGenerator) {}
